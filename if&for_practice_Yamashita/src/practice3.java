...
public class practice3 {
    public static void main(String[] args) {
        ...
        System.out.print("逆二等辺三角形のサイズを入力してください: ");
        ...
        System.out.println(size + "段の逆二等辺三角形を表示します。");
        ...
        for (int i = 1; i <= size; i++) {
            ...
            // 5. 内側のループ (2) - 「＊」の表示
            // (例: 1行目 7個、2行目 5個、3行目 3個、4行目 1個)
            for (int k = 1; k <= (size - i) * 2 + 1; k++) {
                System.out.print("＊"); // ※全角アスタリスク
            }
